        ...
        <div>
            <div className='mx-10 relative  cursor-pointer'>
                ...
                <div className="group relative hover:bg-black  hover:opacity-50">
                   ...
                   <a href={link}> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="orange" className="absolute top-20 left-52 border-2 border-orange-300 p-2 w-20 h-20 cursor-pointer rounded-full invisible group-hover:visible">
