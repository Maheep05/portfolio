...
export function Navbar() {
    ...
    return (
        <div className={`z-10 flex max-w-screen   items-center justify-between bg-black text-white p-2 transition-all duration-500 ${scrollNav ? 'transform translate-y-4 top-0 left-0 right-0 w-auto  mx-[60px]  md:mx-[180px] lg:mx-[200px] fixed  rounded-full' : ''}`}>
            ...
            {displayMenu && (
                <div className={`absolute  z-10 flex flex-col justify-center items-center top-20 left-0 w-screen sm:left-0 sm:w-full   bg-black text-white py-2 px-4 rounded-lg lg:hidden ${scrollNav ? 'top-[82px] left-6 w-[240px] sm:w-screen md:left-12   md:w-96' : ''}`}>
