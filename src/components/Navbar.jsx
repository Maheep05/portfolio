        ...
        <div className={`z-10 flex max-w-full  items-center justify-between bg-black text-white p-2 transition-all duration-500 ${scrollNav ? 'transform translate-y-4 top-0 left-0 right-0 mx-[180px] lg:mx-[200px] fixed  rounded-full' : ''}`}>
            ...
            {displayMenu && (
                <div className={`absolute flex flex-col justify-center items-center top-20 left-0 w-full  bg-black text-white py-2 px-4 rounded-lg lg:hidden ${scrollNav ? 'top-[82px]   w-72' : ''}`}>
                    <span className='cursor-pointer block py-2 hover:bg-yellow-500 hover:text-black hover:rounded-xl'>About</span>
                    <span className='cursor-pointer block py-2 hover:bg-yellow-500 hover:text-black hover:rounded-xl'>Projects</span>
                    <span className='cursor-pointer block py-2 hover:bg-yellow-500 hover:text-black hover:rounded-xl'>Internships</span>
                    <span className='cursor-pointer block py-2 hover:bg-yellow-500 hover:text-black hover:rounded-xl'>Tech Stack</span>
                    <span className='cursor-pointer block py-2 hover:bg-yellow-500 hover:text-black hover:rounded-xl'>Contact</span>
                </div>
            )}
        </div>
    );
