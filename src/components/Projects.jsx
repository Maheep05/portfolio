...
import claritypro from '../assets/clarityproimg.jpg';
...
export function Projects(){
    return(
        <div >
            ...
            <div>
                <h1 className='text-white flex justify-center text-3xl font-semibold my-10' id='projects'>Projects</h1>
            </div>
          ...
          <ProjectCard title={"Clarity Pro"} description={"The productivity management app facilitates seamless collaboration among teams, allowing them to efficiently work on diverse projects. "} img={claritypro} link={"https://github.com/himanjalsaha/CLARITY-PRO"}/>
          </div>
        </div>
    )
}